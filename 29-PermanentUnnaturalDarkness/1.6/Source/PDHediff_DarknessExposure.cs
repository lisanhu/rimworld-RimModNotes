...
public class PDHediff_DarknessExposure : Hediff
{
	...
	{
		if ((PawnUtility.ShouldSendNotificationAbout(pawn) || pawn.IsColonistPlayerControlled || pawn.IsColonySubhumanPlayerControlled) && lastNotifyTick + 5000 < Find.TickManager.TicksGame)
		{
